...
struct LevenbergMarquardt_xxx : public LevenbergMarquardt<_FunctorType>
{
  using LevenbergMarquardt<_FunctorType>::LevenbergMarquardt;
  LevenbergMarquardtSpace::Status minimizeOneStep(FVectorType  &x) override
  {
    using std::abs;
    using std::sqrt;
