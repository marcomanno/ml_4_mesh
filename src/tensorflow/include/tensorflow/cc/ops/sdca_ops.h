...
#ifndef C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SDCA_OPS_H_
#define C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SDCA_OPS_H_
...
class SdcaOptimizer {
 public:
  ...
  struct Attrs {
    ...
    ///
    /// Defaults to true
    TF_MUST_USE_RESULT Attrs Adaptative(bool x) {
      Attrs ret = *this;
      ret.adaptative_ = x;
      return ret;
    }

    bool adaptative_ = true;
  };
...
#endif  // C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_SDCA_OPS_H_
