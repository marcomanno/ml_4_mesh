...
#ifndef C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_CTC_OPS_H_
#define C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_CTC_OPS_H_
...
class CTCBeamSearchDecoder {
 public:
  ...
  struct Attrs {
    ...
    ///
    /// Defaults to true
    TF_MUST_USE_RESULT Attrs MergeRepeated(bool x) {
      Attrs ret = *this;
...
class CTCLoss {
 public:
  ...
  struct Attrs {
    ...
    ///
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs PreprocessCollapseRepeated(bool x) {
      Attrs ret = *this;
    ...
    ///
    /// Defaults to true
    TF_MUST_USE_RESULT Attrs CtcMergeRepeated(bool x) {
      Attrs ret = *this;
    ...
    ///
    /// Defaults to false
    TF_MUST_USE_RESULT Attrs IgnoreLongerOutputsThanInputs(bool x) {
      Attrs ret = *this;
...
#endif  // C__USERS_USER_SOURCE_REPOS_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_CTC_OPS_H_
